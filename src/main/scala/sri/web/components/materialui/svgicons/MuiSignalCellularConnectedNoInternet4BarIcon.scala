...
@exclude key: String | Int = null ): ReactElement { type Instance = MuiSignalCellularConnectedNoInternet4BarIconComponent.type}  = {
      import DangerousUnionToJSAnyImplicit._
      val props = FunctionObjectMacro()
      extraProps.foreach(v => { MergeJSObjects(props, v) })
    CreateElementJS[MuiSignalCellularConnectedNoInternet4BarIconComponent.type](
      MuiSignalCellularConnectedNoInternet4BarIconComponent,
      props,
      key)
    }
