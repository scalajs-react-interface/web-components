...
@exclude key: String | Int = null,
      @exclude ref: js.Function1[MuiFadeComponent.type, Unit] = null)(children: ReactNode*): ReactElement { type Instance = MuiFadeComponent.type}  = {
      import DangerousUnionToJSAnyImplicit._
      val props = FunctionObjectMacro()
      extraProps.foreach(v => { MergeJSObjects(props, v) })
    CreateElementJS[MuiFadeComponent.type](
      MuiFadeComponent,
      props,
      key,
