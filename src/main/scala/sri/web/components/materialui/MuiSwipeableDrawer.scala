...
object MuiSwipeableDrawer {
  ...
  def apply(id: OptionalParam[String] = OptDefault,
            transitionDuration: OptionalParam[Double | Int | js.Object] =
              OptDefault,
            className: OptionalParam[String] = OptDefault,
            onOpen: ReactEventH => _,
            ...
            open: Boolean,
            onClose: ReactEventH => _,
            disableBackdropTransition: OptionalParam[Boolean] = OptDefault,
            anchor: OptionalParam[MuiDrawerAnchor] = OptDefault,
            ...
            @exclude ref: js.Function1[MuiSwipeableDrawerComponent.type, Unit] =
              null)(children: ReactNode*)
    : ReactElement { type Instance = MuiSwipeableDrawerComponent.type } = {
